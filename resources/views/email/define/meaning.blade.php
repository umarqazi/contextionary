...
<?php if($data['type']=='translate'){$data['type']='Translation';}elseif($data['type']=='illustrate'){$data['type']='Illustration';}?>
    <p>Congratulations! Your <span class="text-transform">{!! $data['type'] !!}</span> against '<span class="text-capitalize">{!! $data['phrase_name'] !!}</span>' has got {!! $data['position'] !!} Position in the contest.
