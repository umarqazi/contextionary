    ...
    @if(!Auth::user()->hasRole('guest'))
        <div class="menuCate">
            ...
            <ul class="menuListing">
                <li><a href="{!! lang_route('context-finder') !!}" class="{{ (Request::segment(2) == 'context-finder') ? 'active' : '' }} menu4"><span>Context Finder</span></a></li>
                <li class="">
                    <a href="{!! lang_route('text-history') !!}" class="{{ (Request::segment(2) == 'text-history') ? 'active' : '' }} menu4">
