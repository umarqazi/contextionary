...
<div class="menuCate">
  ...
  <ul class="menuListing">
    @if(Auth::user()->hasRole(Config::get('constant.contributorRole.define')))
      <li class="{{ (Request::segment(2) == 'phrase-list') ? 'active' : '' }}"><a href="{!! lang_route('plist') !!}" class="menu4" style="{{ (Request::segment(2) == 'phrase-list') ? 'background-position: 0 -40px' : '' }}"><span>{!! t('Vote Meanings') !!}</span></a></li>
    @endif
    @if(Auth::user()->hasRole(Config::get('constant.contributorRole.illustrate')))
      <li class="{{ (Request::segment(2) == 'illustrator-vote-list') ? 'active' : '' }}"><a href="{!! lang_route('vIllustratorList') !!}" class="menu4" style="{{ (Request::segment(2) == 'illustrator-vote-list') ? 'background-position: 0 -40px' : '' }}"><span>{!! t('Vote Illustration') !!}</span></a></li>
    @endif
    @if(Auth::user()->hasRole(Config::get('constant.contributorRole.translate')))
      <li class="{{ (Request::segment(2) == 'translate-vote-list') ? 'active' : '' }}"><a href="{!! lang_route('vTranslatorList') !!}" class="menu4" style="{{ (Request::segment(2) == 'translate-vote-list') ? 'background-position: 0 -40px' : '' }}"><span>{!! t('Vote Translations')!!}</span></a></li>
    @endif
  </ul>
</div>
...
<div class="menuCate">
  ...
  <ul class="menuListing">
    ...
    <li class="{{ (Request::segment(2) == 'user-history') ? 'active' : '' }}"><a href="{!! lang_url('user-history') !!}" class="menu7" style="{{ (Request::segment(2) == 'user-history') ? 'background-position: 0 -40px' : '' }}"><span>{!! t('History') !!}</span></a></li>
  </ul>
</div>
