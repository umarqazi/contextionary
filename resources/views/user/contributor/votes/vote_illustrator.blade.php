            ...
            <div class="row mt-4">
                <div class="col-md-8">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{!! lang_route('poor-quality', ['context_id'=>$illustrators['context_id'],'phrase_id'=>$illustrators['phrase_id'],'type'=>'ILLUSTRATE']) !!}" class="orangeBtn waves-light mb-3">{!! t('Poor Quality') !!}</a>
                    </div>
                </div>
