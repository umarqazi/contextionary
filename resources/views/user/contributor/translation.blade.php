...
{!! Form::text('phrase_translation', $data['translation']['phrase_translation'], ['class'=>'form-control' ,'placeholder'=>t('Translate Phrase')]) !!}
...
{!! Form::textarea('translation', $data['translation']['translation'], ['maxlength'=>"2500",'id'=>'meaning-area','class'=>'enter-phrase' ,'placeholder'=>t('Translate Meaning')]) !!}
