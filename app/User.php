...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'first_name', 'last_name','status', 'token', 'email_token','timezone','cus_id','coins', 'provider', 'provider_id', 'signup_from', 'api_token', 'game_coins','aladdin_lamp','butterfly_effect'
    ];
